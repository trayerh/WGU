 ...
 * @author traye
 */
public class Screen_addProductController implements Initializable {
    ...
    public void passInventory(Inventory inventory) {
        ...
        /**System.out.print(inventory.getAllProducts());**/
    }
    ...
    private void saveChanges(ActionEvent event) {
        /** add product **//**bad name, change? **/

        /** init vars for new prod **/
        int id = (1 + inventory.allProducts.size());
